...
export default function Card({ name })
{
	return <div className={styles.root}>
		<div className={styles.title} ref={coolAnim()}>
			...
			<a href="" ref={coolAnim()}><img src={icon1} alt="tg" /></a>
			<a href="" ref={coolAnim()}><img src={icon} alt="gh" /></a>
		</div>
		...
		<div className={styles.tech} ref={coolAnim()}>HTML, CSS, JavaScript, React</div>
	</div>
}
